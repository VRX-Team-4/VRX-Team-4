...
To get production quality looks, don't forget to install post-processing from Windows/Package manager. Be sure to have the post-processing volume and the camera (layer) on the same layer.
